//stage222는 stage2.c와 stage22.c를 업데이트 한 겁니다. 겹치는 파일이라서 구분하기 위해 이렇게 한겁니다.
/* (터미널 값을 적은겁니다.)
II 하고,
=== 훈련 메뉴 ===
1. 체력 및 지식 (통과)
...
7. 연기 및 무대 퍼포먼스
8. 팬 소통
선택 (1-8, 0 메인 메뉴로 돌아가기): Arthur

<<아서의 이스터에그>>
8비트 이진수에 해당하는 글자를 입력하세요.
정답은 총 7 글자입니다.
이진수: 01100101 -> 해당 글자를 입력하세요:
  ㄴ 이렇게 나오는데.
01100101은 e, 01100011는 c, 01110000는 P, 01110010는 r, 01110100는 t, 01100101는 e,  01110011는 s 이렇게 순서대로 작성.

<<아서의 이스터에그>>
8비트 이진수에 해당하는 글자를 입력하세요.
정답은 총 7 글자입니다.
이진수: 01100101 -> 해당 글자를 입력하세요: e

정확합니다!
이진수: 01100011 -> 해당 글자를 입력하세요: c

정확합니다!
이진수: 01110000 -> 해당 글자를 입력하세요: p

정확합니다!
이진수: 01110010 -> 해당 글자를 입력하세요: r

정확합니다!
이진수: 01110100 -> 해당 글자를 입력하세요: t

정확합니다!
이진수: 01100101 -> 해당 글자를 입력하세요: e

정확합니다!
이진수: 01110011 -> 해당 글자를 입력하세요: s

정확합니다!

모든 글자를 올바르게 입력했습니다! 이제 단어 조합을 입력하세요.
글자를 조합하여 단어를 입력하세요: specter
...
#include <string.h>   // strlen, strcmp, strcpy, strchr
...
// New functions for Easter Egg (새로 추가)
